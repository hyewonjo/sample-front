<template>
  <div class="board">
    ...
    <div class="buttons">
      <div class="right">
        <button class="button blue" v-on:click="boardUpdateClick()">수정</button>
  ...
  methods: {
    ...
    async boardUpdateClick() {
      ...
      try {
        ...
        const res = await this.axios.put('http://localhost:9000/boards/' + this.$route.query.boardNo, boardItem);
        console.log(res);
        if (res.data.success) {
          alert('수정되었습니다.');
